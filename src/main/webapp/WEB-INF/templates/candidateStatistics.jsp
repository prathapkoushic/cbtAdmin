		...
		<div class="col-sm-6">
			...
			<div class="panel">
				<div class="panel-body">
					<h3 class="title-hero">Candidate Q &amp; A Statistics Report</h3>
					<div class="example-box-wrapper">
						<form action="generateStatisticReports" method="post" id="form"
							data-parsley-validate="" id="demo-form" class="form-horizontal bordered-row">
