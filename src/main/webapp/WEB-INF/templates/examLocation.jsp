...
<body>
	<div class="container">
		...
		<div class="adminBlock">
			<div class="row">
				<div class="col-md-6">
					<label class="control-label">Click to Exam Location With Session:</label> 
				</div>
				<div class="col-md-6">
					<div class="mgn-left">
						<a href="createlocation" class="btn btn-primary">ExamLocation With Sessions </a>
					</div>
					<!-- <div class="mgn-left">
						<a href="examListUrl" class="btn btn-primary">locationList </a>
					</div> -->
