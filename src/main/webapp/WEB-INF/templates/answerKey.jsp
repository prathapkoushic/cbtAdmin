...
<body>
	...
	<div id="page-title">
		...
		<div class="panel">
			<div class="panel-body">
				<h3 class="title-hero">
					<b>Upload AnswerKey</b>
				</h3>

				<div class="example-box-wrapper">
					<form class="form-horizontal bordered-row" action="uploadAnswerKey"
 ...
 -->
						...
						<div class="form-group">
                            ...
                            <input type="radio" class="" id="radioYes" name="Protected" value="yes" required="required">Yes
                        </label>
                        <label class="radio-inline">
                         <input type="radio" class=" " id="radioNo" name="Protected" value="no" required="required">No  
                        </label>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-5">
								<button id="submit" type="submit"
									class="btn btn-primary btn-hover">Upload</button>
							</div>
						</div>
