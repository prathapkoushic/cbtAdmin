...
<body>
	...
	<div class="panel">
		<div class="panel-body">
			<h3 class="title-hero">POST List</h3>
	...
	<script type="text/javascript">
		...
		function clickForEdit(id){
			...
			$('#postId').val(id);
			$('form').attr('action','editPost');
		}
		function clickForDelete(id){
			
			if(id!=0){
				if(!confirm('it also deletes post related exams and exam locations ')){
					return false;}
				else{
				...
				$.ajax({
					...
					success : function(data) {
						...
						var table =$('#datatable').DataTable();
						var row=	$('#td_remove_'+id).parent();
						
						//table.row('#td_remove_'+id).remove();
