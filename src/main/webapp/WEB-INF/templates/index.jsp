...
<body onclick=" clinkOnBody()">
	...
	<div class="center-vertical bg-black">
		<div class="center-content row">
			<form action="loginurl" id="login-validation"
					...
					<div class="content-box-wrapper pad20A">
						...
						<div class="form-group">
							...
							<div class="input-group input-group-lg">
								...
								</span> <input type="text" class="form-control" id="mail"
						...
						<div class="row">
							...
							<div class="text-right col-md-6">
								<a href="forgot"  title="Recover password">Forgot
									your password?</a>
							</div>
						</div>
					</div>

					<div class="button-pane" id="msg">
