		...
		<div class="panel">
			<div class="panel-body">
				...
				<div class="example-box-wrapper">
					<form class="form-horizontal bordered-row" action="uplaodDescriptiveQuestions"
				        ...
				        <div class="form-group">
							<label class="control-label col-sm-4" for="fullname">Level : </label>
							<div class="col-sm-5">
								
                                <select class="form-control" id="level" name="level">
                                <option value="" selected style="display:none">SELECT LEVEL</option>
